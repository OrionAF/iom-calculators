...
export const STAT_REGISTRY: Readonly<Record<string, StatMeta>> = {
  ...
  pet_quest_level_cap_butterfly: {
    name: 'Butterfly Pet Quest Level Cap',
    description: 'Increases The Level Quest Cap For Butterfly',
    icon: 'Butterfly_Quest.png',
    base: 10,
    unit: 'count',
    sign: '+',
    category: 'pets',
  },
  pet_quest_level_cap_nagini: {
    name: 'Nagini Pet Quest Level Cap',
    description: 'Increases The Level Quest Cap For Nagini',
    icon: 'Nagini_Quest.png',
    base: 10,
    unit: 'count',
    sign: '+',
    category: 'pets',
  },
  pet_quest_level_cap_mr_nibbles: {
    name: 'Mr Nibbles Quest Pet Level Cap',
    description: 'Increases The Level Quest Cap For Mr Nibbles',
    icon: 'Mr_Nibbles_Quest.png',
    base: 10,
    unit: 'count',
    sign: '+',
    category: 'pets',
  },
  pet_quest_level_cap_dino: {
    name: 'Dino Pet Quest Level Cap',
    description: 'Increases The Quest Level Cap For Dino',
    icon: 'Dino_Quest.png',
    base: 10,
    unit: 'count',
    sign: '+',
  ...
  pet_quest_level_cap_starfish: {
    name: 'Starfish Pet Quest Level Cap',
    description: 'Increases The Level Quest Cap For Starfish',
    icon: 'Starfish_Quest.png',
    base: 10,
    unit: 'count',
    sign: '+',
    category: 'pets',
  },
  pet_quest_level_cap_leprechaun: {
    name: 'Leprechaun Pet Quest Level Cap',
    description: 'Increases The Level Cap Quest For Leprechaun',
    icon: 'Leprechaun_Quest.png',
    base: 10,
    unit: 'count',
    sign: '+',
    category: 'pets',
  },
  pet_quest_level_cap_happy_bot: {
    name: 'Happy-Bot Quest Pet Level Cap',
    description: 'Increases The Quest Level Cap For Happy-Bot',
    icon: 'Happybot_Quest.png',
    base: 10,
    unit: 'count',
    sign: '+',
    category: 'pets',
  },
  pet_quest_level_cap_totem: {
    name: 'Totem Pet Quest Level Cap',
    description: 'Increases The Quest Level Cap For Totem',
    icon: 'Totem_Quest.png',
    base: 10,
    unit: 'count',
    sign: '+',
    category: 'pets',
  },
  pet_quest_level_cap_whale: {
    name: 'Whale Pet Quest Level Cap',
    description: 'Increases The Quest Level Cap For Whale',
    icon: 'Whale_Quest.png',
    base: 10,
    unit: 'count',
    sign: '+',
    category: 'pets',
  },
  pet_quest_level_cap_axolotl: {
    name: 'Axolotl Pet Quest Level Cap',
    description: 'Increases The Level Quest Cap For Axolotl',
    icon: 'Axolotl_Quest.png',
    base: 10,
    unit: 'count',
    sign: '+',
    category: 'pets',
  },
  pet_quest_level_cap_penguin: {
    name: 'Penguin Pet Quest Level Cap',
    description: 'Increases The Level Quest Cap For Penguin',
    icon: 'Penguin_Quest.png',
    base: 10,
    unit: 'count',
    sign: '+',
    category: 'pets',
  },
  pet_quest_level_cap_rabbit: {
    name: 'Rabbit Pet Quest Level Cap',
    description: 'Increases The Level Quest Cap For Rabbit',
    icon: 'Rabbit_Quest.png',
    base: 10,
    unit: 'count',
    sign: '+',
    category: 'pets',
  },
  pet_quest_level_cap_duck: {
    name: 'Duck Pet Quest Level Cap',
    description: 'Increases The Quest Level Cap For Duck',
    icon: 'Duck_Quest.png',
    base: 10,
    unit: 'count',
    sign: '+',
  ...
  pet_quest_level_cap_dwarf: {
    name: 'Dwarf Pet Quest Level Cap',
    description: 'Increases The Quest Level Cap For Dwarf',
    icon: 'Dwarf_Quest.png',
    base: 10,
    unit: 'count',
    sign: '+',
    category: 'pets',
  },
  pet_quest_level_cap_crab: {
    name: 'Crab Pet Quest Level Cap',
    description: 'Increases The Quest Level Cap For Crab',
    icon: 'Crab_Quest.png',
    base: 10,
    unit: 'count',
    sign: '+',
