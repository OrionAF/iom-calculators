...
export const starsFormulas: FormulaMap = defineFormulas({
  ...
  star_triple_spawn_chance: {
    contributions: [
      ...
      { source: st.storeVpProgressionTripleStar, op: '+' },
      { source: st.storeVpSupernovaTripleStar, op: '+' },
      { source: st.storeVpSupergiants3TripleStar, op: '+' },
  ...
  super_star_triple_chance: {
    contributions: [
      ...
      { source: st.storeVpSupernovaTripleSuperStar, op: '+' },
    ],
  },
  ...
  super_star_10x_chance: {
    contributions: [
      ...
      { source: st.storeVpSupergiants10xSuperStar, op: '+' },
      { source: st.storeVpSingularity10xSuperStar, op: '+' },
  ...
  star_supernova_chance: {
    contributions: [
      ...
      { source: st.storeVpSupernovaStarNova, op: '+' },
    ],
  },
  ...
  star_supernova_multi: {
    contributions: [
      ...
      { source: st.storeVpSupernovaStarNovaMul, op: '+' },
  ...
  super_star_supernova_chance: {
    contributions: [
      ...
      { source: st.storeVpSupernovaSuperStarNova, op: '+' },
    ],
  },
  ...
  star_supergiant_chance: {
    contributions: [
      ...
      { source: st.storeVpSupergiants3StarsChance, op: '+' },
      ...
      { source: st.storeVpSingularitySupergiantChance, op: '+' },
    ],
  },
  ...
  star_supergiant_multi: {
    contributions: [
      ...
      { source: st.storeVpSupergiants3StarMul, op: '×' },
  ...
  super_star_supergiant_chance: {
    contributions: [
      ...
      { source: st.storeVpSupergiants3SuperStarsChance, op: '+' },
    ],
  },
