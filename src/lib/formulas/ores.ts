...
export const oresFormulas: FormulaMap = defineFormulas({
  ...
  ore_sell_price_multi: {
    contributions: [
      // Wiki: (Easy Progressor + I Have Wares) × Polychrome Power
      {
        label: 'Skill-Tree',
        base: 1,
        op: '×',
      ...
      { source: card.cardMiscJulk, op: '×' },
      { source: st.storeGemOreSellPrice, op: '×' },
      { source: st.storeVpBallerOreSell, op: '×' },
  ...
  ore_income_multi: {
    contributions: [
      { source: st.storePerkOreIncome, op: '×' },
  ...
  golden_ore_chance: {
    contributions: [
      ...
      { source: st.storeVpGoldenOreChance, op: '+' },
  ...
  golden_ore_multi: {
    contributions: [
      ...
      { source: st.storeVpGoldenOreMul, op: '×' },
  ...
  golden_floor_multi: {
    contributions: [
      ...
      { source: card.cardMiscWorld1, op: '×' },
      { source: st.storeVpProgressionGoldenFloor, op: '×' },
