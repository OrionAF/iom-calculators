...
export const staRhythmFloorClear: Source = {
  key: 'construct.staRhythmFloorClear', name: 'Statue of Rhythm (Floor Clear)', system: 'construct',
  maxLevel: 3, fn: (n) => ([0, 0, 0, -0.25] as const)[Math.min(n, 3)], inputs: [],
}
...
export const staAppetiteFuelDuration: Source = {
  key: 'construct.staAppetiteFuelDuration', name: 'Statue of Appetite (Fuel Duration)', system: 'construct',
  maxLevel: 3, fn: (n) => ([0, 0, 0, 0.15] as const)[Math.min(n, 3)], inputs: [],
}
...
export const staFriendshipSkillShard: Source = {
  key: 'construct.staFriendshipSkillShard', name: 'Statue of Friendship (Skill Shard Chance)', system: 'construct',
...
export const staArtistryFreebieRefresh: Source = {
  key: 'construct.staArtistryFreebieRefresh', name: 'Statue of Artistry (Freebie Refresh)', system: 'construct',
  maxLevel: 3, fn: (n) => ([0, 0, 0, 0.01] as const)[Math.min(n, 3)], inputs: [],
}
...
export const staRandomnessRainbowVein: Source = {
  key: 'construct.staRandomnessRainbowVein', name: 'Statue of Randomness (Rainbow Vein)', system: 'construct',
  maxLevel: 3, fn: (n) => ([0, 0, 0, 0.05] as const)[Math.min(n, 3)], inputs: [],
}
...
export const staChildhoodContractCap: Source = {
  key: 'construct.staChildhoodContractCap', name: 'Statue of Childhood (Contract Cap)', system: 'construct',
  maxLevel: 3, fn: (n) => ([0, 1, 2, 4] as const)[Math.min(n, 3)], inputs: [],
}
...
export const staIgnitionGalacticFloor: Source = {
  key: 'construct.staIgnitionGalacticFloor', name: 'Statue of Ignition (Galactic Floor)', system: 'construct',
...
export const staWarmthStarSupergiants: Source = {
  key: 'construct.staWarmthStarSupergiants', name: 'Statue of Warmth (Star Supergiant Multi)', system: 'construct',
  maxLevel: 3, fn: (n) => ([0, 0.35, 0.55, 0.85] as const)[Math.min(n, 3)], inputs: [],
}
...
export const staWarmthSuperStarSupergiants: Source = {
  key: 'construct.staWarmthSuperStarSupergiants', name: 'Statue of Warmth (Super Star Supergiant Multi)', system: 'construct',
  maxLevel: 3, fn: (n) => ([0, 0.35, 0.55, 0.85] as const)[Math.min(n, 3)], inputs: [],
}
...
export const staWarmthStarSupernova: Source = {
  key: 'construct.staWarmthStarSupernova', name: 'Statue of Warmth (Star Supernova Multi)', system: 'construct',
...
export const staAffluenceTripleContract: Source = {
  key: 'construct.staAffluenceTripleContract', name: 'Statue of Affluence (Triple Contract)', system: 'construct',
...
export const staAffluence10xContract: Source = {
  key: 'construct.staAffluence10xContract', name: 'Statue of Affluence (10x Contract)', system: 'construct',
  maxLevel: 3, fn: (n) => ([0, 0.01, 0.02, 0.04] as const)[Math.min(n, 3)], inputs: [],
}
/** Statue of Affluence: Contract Upgrade Cap +1 / +2 / +3. → contract_cap_increase */
export const staAffluenceContractCap: Source = {
  key: 'construct.staAffluenceContractCap', name: 'Statue of Affluence (Contract Cap)', system: 'construct',
  maxLevel: 3, fn: (n) => ([0, 1, 2, 3] as const)[Math.min(n, 3)], inputs: [],
}
...
export const staEastwoodFreebieTimer: Source = {
  key: 'construct.staEastwoodFreebieTimer', name: 'Statue of Eastwood (Freebie Timer)', system: 'construct',
  maxLevel: 3, fn: (n) => ([0, 30, 45, 60] as const)[Math.min(n, 3)], inputs: [],
}
...
export const staRodentiaChainCap: Source = {
  key: 'construct.staRodentiaChainCap', name: 'Statue of Rodentia (Chain Drone Cap)', system: 'construct',
  maxLevel: 1,
...
export const staRodentiaRadiantChance: Source = {
  key: 'construct.staRodentiaRadiantChance', name: 'Statue of Rodentia (Super Star Radiant Chance)', system: 'construct',
  maxLevel: 1,
...
export const staComfortScorpioCap: Source = {
  key: 'construct.staComfortScorpioCap', name: 'Statue of Comfort (Scorpio Cap)', system: 'construct',
...
export const staComfortCapricornCap: Source = {
  key: 'construct.staComfortCapricornCap', name: 'Statue of Comfort (Capricorn Cap)', system: 'construct',
  maxLevel: 1, fn: (o) => o * 20, inputs: [],
}
...
export const staTimekeepingRadiantChance: Source = {
  key: 'construct.staTimekeepingRadiantChance', name: 'Statue of Timekeeping (Star Radiant Chance)', system: 'construct',
  maxLevel: 1,
...
export const staTimekeepingStarRadiantMul: Source = {
  key: 'construct.staTimekeepingStarRadiantMul', name: 'Statue of Timekeeping (Star Radiant Multi)', system: 'construct',
...
export const staTimekeepingSuperStarRadiantMul: Source = {
  key: 'construct.staTimekeepingSuperStarRadiantMul', name: 'Statue of Timekeeping (Super Star Radiant Multi)', system: 'construct',
  maxLevel: 1, fn: (o) => o * 0.20, inputs: [],
}
...
export const staCombatStonksChance: Source = {
  key: 'construct.staCombatStonksChance', name: 'Statue of Combat (Stonks Chance)', system: 'construct',
  maxLevel: 1,
...
export const staCombatStonksMul: Source = {
  key: 'construct.staCombatStonksMul', name: 'Statue of Combat (Stonks Multi)', system: 'construct',
...
export const staCombatUltraStonksMul: Source = {
  key: 'construct.staCombatUltraStonksMul', name: 'Statue of Combat (Ultra Stonks Multi)', system: 'construct',
  maxLevel: 1, fn: (o) => o * 0.10, inputs: [],
}
/** Statue of Combat: Ultra Stonks Chance +2% (flat). → ultra_stonks_chance */
export const staCombatUltraStonksChance: Source = {
  key: 'construct.staCombatUltraStonksChance', name: 'Statue of Combat (Ultra Stonks Chance)', system: 'construct',
  maxLevel: 1, fn: (o) => o * 0.02, inputs: [],
}
...
export const staNatureGemBombGem: Source = {
  key: 'construct.staNatureGemBombGem', name: 'Statue of Nature (Gem Bomb Gem Chance)', system: 'construct',
  maxLevel: 1,
...
export const staNatureRainbowVein: Source = {
  key: 'construct.staNatureRainbowVein', name: 'Statue of Nature (Rainbow Vein Chance)', system: 'construct',
  maxLevel: 1, fn: (o) => o * 0.10, inputs: [],
}
...
export const staSemblanceRainbowPortal: Source = {
  key: 'construct.staSemblanceRainbowPortal', name: 'Statue of Semblance (Rainbow Portal)', system: 'construct',
  maxLevel: 1,
...
export const staCrochetGoldenOre: Source = {
  key: 'construct.staCrochetGoldenOre', name: 'Statue of Crochet (Golden Ore Chance)', system: 'construct',
  maxLevel: 1,
...
export const staCrochetGalacticFloor: Source = {
  key: 'construct.staCrochetGalacticFloor', name: 'Statue of Crochet (Galactic Floor Chance)', system: 'construct',
  maxLevel: 1, fn: (o) => o * 0.05, inputs: [],
}
/** Statue of Crochet: Prismatic Floor Chance +3% (flat). → prismatic_floor_chance */
export const staCrochetPrismaticFloor: Source = {
  key: 'construct.staCrochetPrismaticFloor', name: 'Statue of Crochet (Prismatic Floor Chance)', system: 'construct',
...
export const staAntagonismFroggerCap: Source = {
  key: 'construct.staAntagonismFroggerCap', name: 'Statue of Antagonism (Frogger Cap)', system: 'construct',
  maxLevel: 1,
...
export const staFallacyPrismaticMul: Source = {
  key: 'construct.staFallacyPrismaticMul', name: 'Statue of Fallacy (Prismatic Floor Multi)', system: 'construct',
  maxLevel: 1,
  fn: (owned, rt) => owned === 0 ? 0 : (rt['w4StatueCount'] ?? 0) * 0.10,
  inputs: [{ key: 'w4StatueCount', label: 'W4 Statues Owned', type: 'integer', min: 0 }],
}
/** Statue of Fallacy: Freebie Gems +3 per W4 Statue. → freebie_gems_bonus */
export const staFallacyFreebieGems: Source = {
  key: 'construct.staFallacyFreebieGems', name: 'Statue of Fallacy (Freebie Gems)', system: 'construct',
  maxLevel: 1,
...
export const staFallacyVeinseekerCap: Source = {
  key: 'construct.staFallacyVeinseekerCap', name: 'Statue of Fallacy (Veinseeker Cap)', system: 'construct',
  maxLevel: 1,
...
export const constructSources = {
  // W1
  staRhythmPickaxe, staRhythmFloorClear,
  staAwarenessBombDmg, staAwarenessUltraCrit,
  staSlayingPrestigePts, staSlayingArtifactCap,
  staAppetiteBombCap, staAppetiteFuelDuration,
  staFriendshipFreebieGems, staFriendshipSkillShard,
  staHygieneGemUpgradeCap,
  staArtistryFreebie5x, staArtistryFreebieRefresh,
