...
export const perkOreIncome: Source = {
  key: "store.perk.oreIncome",
  name: "2x Ore Income (Perk)",
  system: "store",
  maxLevel: 1,
  statKey: "ore_income_multi",
  op: "×",
  fn: (o) => 1 + o * 1,
  inputs: [],
};
...
const founderFn =
  (unlockTier: number, base: number, incr: number) => (tier: number) => {
