...
export const yummyPizzaAllFloorPerm: Source = {
  key: 'items.yummyPizzaPerm',
  name: 'Yummy Pizza (permanent)',
  system: 'items',
  maxLevel: 200,
  fn: (n) => n * 0.01,
  inputs: [],
...
export const lootbugLanternSpawn: Source = {
  key: 'items.lootbugLantern',
  name: 'Lootbug Lantern',
  system: 'items',
  type: 'buff',
  maxLevel: 1,
  fn: (a) => 1 + a * 2.0,
...
export const lootbugLanternPermCap: Source = {
  key: 'items.lootbugLanternPerm',
  name: 'Lootbug Lantern (permanent cap)',
  system: 'items',
  maxLevel: 25,
  fn: (n) => n,
  inputs: [],
...
export const goldFlakeSteakBuff: Source = {
  key: 'items.goldFlakeSteak',
  name: 'Gold Flake Steak',
  system: 'items',
  type: 'buff',
  maxLevel: 1,
  fn: (a) => 1 + a * 2.0,
...
export const goldFlakeSteakPerm: Source = {
  key: 'items.goldFlakeSteakPerm',
  name: 'Gold Flake Steak (permanent)',
  system: 'items',
  maxLevel: 500,
  fn: (n) => n * 0.001,
  inputs: [],
...
export const cosmicCandyPerm: Source = {
  key: 'items.cosmicCandyPerm',
  name: 'Cosmic Candy (permanent)',
  system: 'items',
  maxLevel: 250,
  fn: (n) => n * 0.001,
  inputs: [],
...
export const goldenEyeOfNewtTripleRock: Source = {
  key: 'items.goldenEyeOfNewt',
  name: 'Golden Eye of Newt',
  system: 'items',
  type: 'buff',
  maxLevel: 1,
  fn: (a) => a * 0.5,
...
export const goldenChaosTotemBombDamage: Source = {
  key: 'items.goldenChaosTotem',
  name: 'Golden Chaos Totem',
  system: 'items',
  type: 'buff',
  maxLevel: 1,
  fn: (a) => 1 + a * 8.0,
...
export const goldenPrimalMeatPickaxe: Source = {
  key: 'items.goldenPrimalMeat',
  name: 'Golden Primal Meat',
  system: 'items',
  type: 'buff',
  maxLevel: 1,
  fn: (a) => a * 2.0,
...
export const goldenHamburgerPickaxe: Source = {
  key: 'items.goldenHamburger',
  name: 'Golden Hamburger',
  system: 'items',
  type: 'buff',
  maxLevel: 1,
  fn: (a) => 1 + a * 5.0,
...
export const goldenRainbowLollipopChance: Source = {
  key: 'items.goldenRainbowLollipop',
  name: 'Golden Rainbow Lollipop',
  system: 'items',
  type: 'buff',
  maxLevel: 1,
  fn: (a) => a * 0.06,
...
export const goldenYummyPizzaGoldenFloor: Source = {
  key: 'items.goldenYummyPizza',
  name: 'Golden Yummy Pizza',
  system: 'items',
  type: 'buff',
  maxLevel: 1,
  fn: (a) => 1 + a * 0.3,
...
export const goldenYummyPizzaAllFloorPerm: Source = {
  key: 'items.goldenYummyPizzaPerm',
  name: 'Golden Yummy Pizza (permanent)',
  system: 'items',
  maxLevel: 250,
  fn: (n) => n * 0.01,
  inputs: [],
...
export const goldenLootbugLanternSpawn: Source = {
  key: 'items.goldenLootbugLantern',
  name: 'Golden Lootbug Lantern',
  system: 'items',
  type: 'buff',
  maxLevel: 1,
  fn: (a) => 1 + a * 5.0,
...
export const goldenLootbugLanternPermCap: Source = {
  key: 'items.goldenLootbugLanternPerm',
  name: 'Golden Lootbug Lantern (permanent cap)',
  system: 'items',
  maxLevel: 50,
  fn: (n) => n,
  inputs: [],
...
export const goldenCosmicCandyBuff: Source = {
  key: 'items.goldenCosmicCandy',
  name: 'Golden Cosmic Candy',
  system: 'items',
  type: 'buff',
  maxLevel: 1,
  fn: (a) => 1 + a * 4.0,
...
export const goldenCosmicCandyPerm: Source = {
  key: 'items.goldenCosmicCandyPerm',
  name: 'Golden Cosmic Candy (permanent)',
  system: 'items',
  maxLevel: 500,
  fn: (n) => n * 0.001,
  inputs: [],
