...
describe('fishingSources — Tier 1 Upgrades', () => {
  ...
  it('fishMultiT1: +0.03 per level', () => {
    expect(fishingSources.fishMultiT1.fn(10, {})).toBeCloseTo(0.30)
  })

  it('rodMultiT1: factor = 1 + level × 0.04', () => {
    expect(fishingSources.rodMultiT1.fn(0, {})).toBeCloseTo(1)
    expect(fishingSources.rodMultiT1.fn(10, {})).toBeCloseTo(1.40)
  })

  it('droneMultiT1: +0.06 per level', () => {
    expect(fishingSources.droneMultiT1.fn(20, {})).toBeCloseTo(1.20)
  })
...
describe('fishingSources — Tier 2 Upgrades', () => {
  it('shinyMultiT2: +0.05 per level', () => {
    expect(fishingSources.shinyMultiT2.fn(20, {})).toBeCloseTo(1.00)
  })

  it('tier2DockT2: +0.05 per level', () => {
    expect(fishingSources.tier2DockT2.fn(10, {})).toBeCloseTo(0.50)
  })

  it('superShinyChanceT2: +0.01 per level', () => {
    expect(fishingSources.superShinyChanceT2.fn(20, {})).toBeCloseTo(0.20)
  })
...
describe('fishingSources — Tier 1 Enhancements', () => {
  it('fishMultiE1: +0.05 per level', () => {
    expect(fishingSources.fishMultiE1.fn(10, {})).toBeCloseTo(0.50)
  })
  ...
  it('rodMultiE1: factor = 1 + level × 0.05', () => {
    ...
    expect(fishingSources.rodMultiE1.fn(10, {})).toBeCloseTo(1.50)
  })
  ...
  it('droneMultiE1: +0.08 per level', () => {
    expect(fishingSources.droneMultiE1.fn(25, {})).toBeCloseTo(2.00)
  })

  it('tokenMultiE1: +0.05 per level', () => {
    expect(fishingSources.tokenMultiE1.fn(20, {})).toBeCloseTo(1.00)
  })

  it('doubleTickE1: +0.005 per level', () => {
    expect(fishingSources.doubleTickE1.fn(20, {})).toBeCloseTo(0.10)
  })

  it('tinyNoticeE1: +0.005 per level', () => {
    expect(fishingSources.tinyNoticeE1.fn(20, {})).toBeCloseTo(0.10)
  })

  it('shinyMultiE1: +0.05 per level', () => {
    expect(fishingSources.shinyMultiE1.fn(20, {})).toBeCloseTo(1.00)
  })
...
describe('fishingSources — Tier 2 Enhancements', () => {
  it('tripleTickE2: +0.004 per level', () => {
    expect(fishingSources.tripleTickE2.fn(20, {})).toBeCloseTo(0.080)
  })

  it('superShinyMultiE2: +0.15 per level', () => {
    expect(fishingSources.superShinyMultiE2.fn(20, {})).toBeCloseTo(3.00)
  })

  it('tier2DockE2: +0.05 per level', () => {
    expect(fishingSources.tier2DockE2.fn(20, {})).toBeCloseTo(1.00)
  })
})
