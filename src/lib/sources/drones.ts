...
export const droneUpgradeDamage: Source = {
  key: 'drones.upgrade.damage', name: 'Drone Upgrade – Damage', system: 'drones',
  maxLevel: 10, fn: (n) => n * 0.20, inputs: [],
}
/** Drone Radius +12% per level. Max 10. → drone_radius_percent */
export const droneUpgradeRadius: Source = {
  key: 'drones.upgrade.radius', name: 'Drone Upgrade – Radius', system: 'drones',
...
export const droneUpgradeMovespeed: Source = {
  key: 'drones.upgrade.movespeed', name: 'Drone Upgrade – Movespeed', system: 'drones',
...
export const droneUpgradeAttackSpeed: Source = {
  key: 'drones.upgrade.attackSpeed', name: 'Drone Upgrade – Attack Speed', system: 'drones',
  maxLevel: 10, fn: (n) => n * 0.10, inputs: [],
}
/** Drone Triple Damage Chance +2% per level. Max 15. → drone_triple_damage_chance */
export const droneUpgradeTripleDmg: Source = {
  key: 'drones.upgrade.tripleDmg', name: 'Drone Upgrade – Triple Damage Chance', system: 'drones',
...
export const droneUpgradeRapidFire: Source = {
  key: 'drones.upgrade.rapidFire', name: 'Drone Upgrade – Rapid Fire Chance', system: 'drones',
  maxLevel: 15, fn: (n) => n * 0.02, inputs: [],
}
...
export const droneSuitVeinseekerPassive: Source = {
  key: 'drones.suit.veinseeker.passive', name: 'Veinseeker Suit (Passive)', system: 'drones',
...
export const droneSuitStarburstPassive: Source = {
  key: 'drones.suit.starburst.passive', name: 'Starburst Suit (Passive)', system: 'drones',
  maxLevel: 1, fn: (o) => o * 0.06, inputs: [],
}
/**
...
export const droneSuitVoidPassive: Source = {
  key: 'drones.suit.void.passive', name: 'Void Suit (Passive)', system: 'drones',
  maxLevel: 1, fn: (o) => o * 0.10, inputs: [],
}
...
export const droneSuitBearUpgrade: Source = {
  key: 'drones.suit.bear.upgrade', name: 'Bomb Bear Suit Upgrade (Bomb Damage)', system: 'drones',
  maxLevel: 15, fn: (n) => n * 0.15, inputs: [],
}
...
export const droneSuitVeinseekerUpgrade: Source = {
  key: 'drones.suit.veinseeker.upgrade', name: 'Veinseeker Suit Upgrade', system: 'drones',
  maxLevel: 15, fn: (n) => n * 0.02, inputs: [],
}
...
export const droneSuitStarburstUpgrade: Source = {
  key: 'drones.suit.starburst.upgrade', name: 'Starburst Suit Upgrade', system: 'drones',
  maxLevel: 15, fn: (n) => n * 0.01, inputs: [],
}
/** Void suit upgrade: Portal Ore Chance +2% per level. Max 15. → void_portal_chance */
export const droneSuitVoidUpgrade: Source = {
  key: 'drones.suit.void.upgrade', name: 'Void Suit Upgrade (Portal Chance)', system: 'drones',
  maxLevel: 15, fn: (n) => n * 0.02, inputs: [],
}
/**
...
export const droneSuitAnglerUpgrade: Source = {
  key: 'drones.suit.angler.upgrade', name: 'Angler Suit Upgrade', system: 'drones',
  maxLevel: 15, fn: (n) => n * 40, inputs: [],
}
...
export const droneSuitPrismUpgrade: Source = {
  key: 'drones.suit.prism.upgrade', name: 'Prism Suit Upgrade', system: 'drones',
  maxLevel: 15, fn: (n) => n * 0.0025, inputs: [],
}
...
export const dronePrismGradePassive: Source = {
  key: 'drones.grade.prism', name: 'Prism Drone Grade (Galactic Chance)', system: 'drones',
  maxLevel: 40, fn: (n) => n * 0.0025, inputs: [],
}
...
export const droneMidasEnhancementAllStar: Source = {
  key: 'drones.grade.midasEnhancement', name: 'Midas Drone Enhancement (All Star Multi)', system: 'drones',
  maxLevel: 100, fn: (n) => n * 0.005, inputs: [],
}
...
export const coalCoalProduction: Source = {
  key: 'drones.coal.coalProduction', name: 'Coal Upgrade – Coal Production', system: 'drones',
  maxLevel: 25, fn: (n) => n * 1, inputs: [],
}
/** Fuel Duration +1% per level. Max 25. → coal_fuel_duration_multi */
export const coalFuelDuration: Source = {
  key: 'drones.coal.fuelDuration', name: 'Coal Upgrade – Fuel Duration', system: 'drones',
  maxLevel: 25, fn: (n) => n * 0.01, inputs: [],
}
/** Coal Capacity +10% per level. Max 25. → coal_capacity_multi */
export const coalCoalCapacity: Source = {
  key: 'drones.coal.coalCapacity', name: 'Coal Upgrade – Coal Capacity', system: 'drones',
  maxLevel: 25, fn: (n) => n * 0.10, inputs: [],
}
/** Fuel Save Chance +1% per level. Max 25. → coal_fuel_save_chance */
export const coalFuelSave: Source = {
  key: 'drones.coal.fuelSave', name: 'Coal Upgrade – Fuel Save Chance', system: 'drones',
  maxLevel: 25, fn: (n) => n * 0.01, inputs: [],
}
/** Drone Exp Gain +5% per level. Max 25. → coal_drone_exp_multi */
export const coalDroneExp: Source = {
  key: 'drones.coal.droneExp', name: 'Coal Upgrade – Drone Exp Gain', system: 'drones',
  maxLevel: 25, fn: (n) => n * 0.05, inputs: [],
}
/** Drone Suit Upgrade Cap +1 per level. Max 7. → drone_suit_cap */
export const coalSuitCap: Source = {
  key: 'drones.coal.suitCap', name: 'Coal Upgrade – Suit Upgrade Cap', system: 'drones',
  maxLevel: 7, fn: (n) => n, inputs: [],
}
...
export const coalVoidPortalMul: Source = {
  key: 'drones.coal.voidPortalMul', name: 'Coal Upgrade – Void Portal Base Multi', system: 'drones',
  maxLevel: 20, fn: (n) => n * 0.01, inputs: [],
}
/** Gleaming Vein Multiplier +6% per level. Max 20. → gleaming_vein_multi */
export const coalGleamingVein: Source = {
  key: 'drones.coal.gleamingVein', name: 'Coal Upgrade – Gleaming Vein Multi', system: 'drones',
  maxLevel: 20, fn: (n) => n * 0.06, inputs: [],
}
/** Lootfrog 10× Spawn Chance +0.05% per level. Max 20. → lootfrog_10x_spawn_chance */
export const coalLootfrog10x: Source = {
  key: 'drones.coal.lootfrog10x', name: 'Coal Upgrade – Lootfrog 10x Spawn Chance', system: 'drones',
  maxLevel: 20, fn: (n) => n * 0.0005, inputs: [],
}
// NOTE: 'Unlock Drone Infernal Cards' (max 1) — unlock mechanic, no stat key.

export const droneSources = {
  // Drone upgrade menu
  droneUpgradeDamage, droneUpgradeRadius, droneUpgradeMovespeed,
  droneUpgradeAttackSpeed, droneUpgradeTripleDmg, droneUpgradeRapidFire,
  // Suit passives
  droneSuitVeinseekerPassive, droneSuitStarburstPassive, droneSuitVoidPassive,
  // Suit upgrades
  droneSuitBearUpgrade, droneSuitVeinseekerUpgrade, droneSuitStarburstUpgrade,
  droneSuitVoidUpgrade, droneSuitAnglerUpgrade, droneSuitPrismUpgrade,
  // Grade passives
  dronePrismGradePassive, droneMidasEnhancementAllStar,
  // Coal upgrades
  coalCoalProduction, coalFuelDuration, coalCoalCapacity, coalFuelSave,
  coalDroneExp, coalSuitCap, coalVoidPortalMul, coalGleamingVein, coalLootfrog10x,
}
