...
export const petCrabSkinWorkshopCap: Source = {
  key: 'pets.crabSkin', name: 'Pet Skin: Crab (Workshop Cap)', system: 'pets',
...
export const petCrabQuestBomBofPlenty: Source = {
  key: 'pets.crabQuest', name: 'Pet Quest: Crab (Plenty Bomb Multi)', system: 'pets',
  maxLevel: 10, fn: (n) => n * 0.5, inputs: [],
}
...
export const petDwarfSkinPickaxeDmg: Source = {
  key: 'pets.dwarfSkin', name: 'Pet Skin: Dwarf (Pickaxe Damage)', system: 'pets',
  maxLevel: 1, fn: (o) => o * 0.50, inputs: [],
}
...
export const petDuckSkinObeliskArmor: Source = {
  key: 'pets.duckSkin', name: 'Pet Skin: Duck (Obelisk Armor)', system: 'pets',
...
export const petRabbitQuestContractCost: Source = {
  key: 'pets.rabbitQuest', name: 'Pet Quest: Rabbit (Contract Cost)', system: 'pets',
  maxLevel: 10, fn: (n) => n * 0.01, inputs: [],
}
...
export const petPenguinSkinOreSell: Source = {
  key: 'pets.penguinSkin', name: 'Pet Skin: Penguin (Ore Sell Price)', system: 'pets',
  maxLevel: 1, fn: (o) => o * 0.50, inputs: [],
}
...
export const petAxolotlSkinFuelDuration: Source = {
  key: 'pets.axolotlSkin', name: 'Pet Skin: Axolotl (Fuel Duration)', system: 'pets',
  maxLevel: 1, fn: (o) => o * 0.10, inputs: [],
}
...
export const petAxolotlQuestArchFragment: Source = {
  key: 'pets.axolotlQuest', name: 'Pet Quest: Axolotl (Arch Fragment)', system: 'pets',
  maxLevel: 10, fn: (n) => n * 0.03, inputs: [],
}
/** Axolotl Quest: Star Supernova Multi +3% per rank. → star_supernova_multi */
export const petAxolotlQuestSupernovaMul: Source = {
  key: 'pets.axolotlQuest', name: 'Pet Quest: Axolotl (Supernova Multi)', system: 'pets',
  maxLevel: 10, fn: (n) => n * 0.03, inputs: [],
}
...
export const petWhaleLootbugTriple: Source = {
  key: 'pets.whale', name: 'Pet: Whale (Triple Lootbug)', system: 'pets',
  fn: (n) => n * 0.03, inputs: [],
}
/** Whale skin: Lootbug Gem Cost -2 (binary). → lootbug_gem_cost_reduction */
export const petWhaleSkinLootbugGem: Source = {
  key: 'pets.whaleSkin', name: 'Pet Skin: Whale (Lootbug Gem Cost)', system: 'pets',
...
export const petWhaleQuestGemBombGem: Source = {
  key: 'pets.whaleQuest', name: 'Pet Quest: Whale (Gem Bomb Gem Chance)', system: 'pets',
  maxLevel: 10, fn: (n) => n * 0.001, inputs: [],
}
...
export const petTotemSkinRainbowVein: Source = {
  key: 'pets.totemSkin', name: 'Pet Skin: Totem (Rainbow Vein Chance)', system: 'pets',
...
export const petTotemQuestDroneExp: Source = {
  key: 'pets.totemQuest', name: 'Pet Quest: Totem (Drone Exp)', system: 'pets',
  maxLevel: 10, fn: (n) => n * 0.04, inputs: [],
}
...
export const petTotemQuestChainDroneCap: Source = {
  key: 'pets.totemQuest', name: 'Pet Quest: Totem (Chain Drone Cap)', system: 'pets',
...
export const petLeprechaunSkinRainbowFloor: Source = {
  key: 'pets.leprechaunSkin', name: 'Pet Skin: Leprechaun (Rainbow Floor)', system: 'pets',
...
export const petLeprechaunQuestGalacticMul: Source = {
  key: 'pets.leprechaunQuest', name: 'Pet Quest: Leprechaun (Galactic Floor Multi)', system: 'pets',
  maxLevel: 10, fn: (n) => n * 0.04, inputs: [],
}
...
export const petLeprechaunQuestTransmuterBop: Source = {
  key: 'pets.leprechaunQuest', name: 'Pet Quest: Leprechaun (Transmuter BoP)', system: 'pets',
  maxLevel: 10, fn: (n) => n * 0.02, inputs: [],
}
...
export const petStarfishSuper10xChance: Source = {
  key: 'pets.starfish', name: 'Pet: Starfish (Super 10x Chance)', system: 'pets',
  fn: (n) => n * 0.002, inputs: [],
}
...
export const petNibblesShinyFishMul: Source = {
  key: 'pets.mrNibbles', name: 'Pet: Mr Nibbles (Shiny Fish Multi)', system: 'pets',
  fn: (n) => n * 0.03, inputs: [],
}
...
export const petNibblesSkinShinyChance: Source = {
  key: 'pets.mrNibblesSkin', name: 'Pet Skin: Mr Nibbles (Shiny Chance)', system: 'pets',
  maxLevel: 1, fn: (o) => o * 0.02, inputs: [],
}
...
export const petNibblesQuestTier2Dock: Source = {
  key: 'pets.mrNibblesQuest', name: 'Pet Quest: Mr Nibbles (Tier 2 Dock)', system: 'pets',
...
export const petNaginiAllFloorMul: Source = {
  key: 'pets.nagini', name: 'Pet: Nagini (All Floor Multi)', system: 'pets',
  fn: (n) => n * 0.02, inputs: [],
}
/** Nagini skin: Golden Ore Chance +2% (binary). → golden_ore_chance */
export const petNaginiSkinGoldenOre: Source = {
  key: 'pets.naginiSkin', name: 'Pet Skin: Nagini (Golden Ore Chance)', system: 'pets',
  maxLevel: 1, fn: (o) => o * 0.02, inputs: [],
}
...
export const petButterflyGalacticChance: Source = {
  key: 'pets.butterfly', name: 'Pet: Butterfly (Galactic Floor Chance)', system: 'pets',
  fn: (n) => n * 0.005, inputs: [],
}
...
export const petButterflyRainbowPortal: Source = {
  key: 'pets.butterfly', name: 'Pet: Butterfly (Rainbow Portal)', system: 'pets',
  fn: (n) => n * 0.0025, inputs: [],
}
...
export const petButterflyQuestBigFrog: Source = {
  key: 'pets.butterflyQuest', name: 'Pet Quest: Butterfly (Big Frog Chance)', system: 'pets',
  maxLevel: 10, fn: (n) => n * 0.0025, inputs: [],
}
...
export const petButterflyQuestPrismaticMul: Source = {
  key: 'pets.butterflyQuest', name: 'Pet Quest: Butterfly (Prismatic Multi)', system: 'pets',
  maxLevel: 10, fn: (n) => n * 0.10, inputs: [],
}
...
export const petSources = {
  ...
  petRabbitQuest5xContract, petRabbitQuestContractCost,
  // Penguin
  ...
  petAxolotlQuestArchFragment, petAxolotlQuestSupernovaMul,
  // Whale
  petWhalePickaxeDmg, petWhaleLootbugTriple,
  petWhaleSkinLootbugGem,
  petWhaleQuestGemBombGem, petWhaleQuestLootbugBank,
  // Totem
  petTotemVeinSpawn, petTotemGoldenVeinChance, petTotemGoldenVeinMul,
  petTotemSkinRainbowVein,
  petTotemQuestDroneExp, petTotemQuestChainDroneCap,
  // Happy-Bot
  petHappyBotArtifactT4Cap,
  petHappyBotSkinContractCap,
  petHappyBotQuestPolyOre, petHappyBotQuestPolyStar, petHappyBotQuestPolyVein,
  ...
  petLeprechaunQuestGalacticMul, petLeprechaunQuestTransmuterBop,
  // Starfish
  petStarfishSuper10xChance, petStarfishSupernovaChance,
  petStarfishSkinStarSpawn,
  petStarfishQuestNovagiant, petStarfishQuestCapricornCap,
  // Dino
  petDinoPickaxeDmg, petDinoRainbowFloor,
  // Mr Nibbles
  petNibblesShinyFishMul, petNibblesTripleTick,
  petNibblesSkinShinyChance,
  petNibblesQuestTier2Dock,
  // Nagini
  petNaginiGoldenOreMul, petNaginiAllFloorMul,
  petNaginiSkinGoldenOre,
  petNaginiQuestGoldenVoidChance, petNaginiQuestGoldenVoidMul,
  // Butterfly
  petButterflyGalacticChance, petButterflyLootfrogTriple, petButterflyRainbowPortal,
  petButterflyQuestBigFrog, petButterflyQuestPrismaticMul,
}
