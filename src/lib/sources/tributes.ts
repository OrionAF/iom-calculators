...
export const trRainbowTroutT1LC = tr('RainbowTroutT1LC', 'Tribute: Rainbow Trout T1 - Leprechaun Cap +3', 'pet_level_cap_leprechaun', '+', (n) => n * 3)
...
export const trRainbowTroutT2MNC = tr('RainbowTroutT2MNC', 'Tribute: Rainbow Trout T2 - Mr Nibbles Cap +3', 'pet_level_cap_mr_nibbles', '+', (n) => n * 3)
...
export const trDuneEelwormT1HC = tr('DuneEelwormT1HC', "Tribute: Dune's Eelworm T1 - Hercules Cap +3", 'star_hercules_cap', '+', (n) => n * 3)
export const trDuneEelwormT1DC = tr('DuneEelwormT1DC', "Tribute: Dune's Eelworm T1 - Draco Cap +3", 'star_draco_cap', '+', (n) => n * 3)
...
export const trGlacialShellstealerT1TC = tr('GlacialShellstealerT1TC', 'Tribute: Glacial Shellstealer T1 - Totem Cap +5', 'pet_level_cap_totem', '+', (n) => n * 5)
...
export const trMegalodonT1CC = tr('MegalodonT1CC', 'Tribute: Megalodon T1 - Cancer Cap +10', 'star_cancer_cap', '+', (n) => n * 10)
...
export const trStormSerpentT1CPC = tr('StormSerpentT1CPC', 'Tribute: Storm Serpent T1 - Crab Pet Cap +5', 'pet_level_cap_crab', '+', (n) => n * 5)
...
export const trStormSerpentT2CSC = tr('StormSerpentT2CSC', 'Tribute: Storm Serpent T2 - Cetus Star Cap +10', 'star_cetus_cap', '+', (n) => n * 10)
...
export const trMeltingGibbousT1NUC = tr('MeltingGibbousT1NUC', 'Tribute: Melting Gibbous T1 - Notice Upgrade Cap +5', 'fishing_notice_upgrade_cap', '+', (n) => n * 5)
export const trMeltingGibbousT2PQC = tr('MeltingGibbousT2PQC', 'Tribute: Melting Gibbous T2 - Pet Quest Cap +1', 'pet_quest_level_cap', '+', (n) => n * 1)
