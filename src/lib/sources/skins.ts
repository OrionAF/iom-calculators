...
export const skinsSources = {
    snMythicChanceFromRelicT1, snOreSellPrice, snMythicChanceFromRelicT2,
    snPrestigePointGain, snExpGain, snFloorClearReq,
    snLootbugGemPrice, snBoPmultiT1, snTripleContractChance,
    snGameSpeedT1, snTripleLootbugChance, snPetLevelUpChance,
    snBombCapacity, snBankedFreebies, snBoPmultiT2,
    snDroneGradeExpGain, snAllFloorMulti, snGameSpeedT2,
    snGemBombGemChance, snStonksMulti, snBankedFreebiesLootbugs,
    snUnlockItemGoldenChaosTotem, snBagSkins
}